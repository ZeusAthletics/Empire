...
import type { PublicProposal, SideQuestProposalPayload } from "@/server/domain/nyx/proposalTypes";
...
function asPayload(value: unknown): SideQuestProposalPayload | null {
