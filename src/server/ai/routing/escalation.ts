...
const TIER_BY_RANK: ModelTier[] = ["ECONOMY", "BALANCED", "STRATEGIC", "DIRECTOR"];
...
export const TASK_DEFAULT_TIER: Record<IntelligenceTask, ModelTier> = {
  ...
  NYX_OUTREACH: "BALANCED",
  NYX_RELATIONSHIP_REVIEW: "BALANCED",
  NYX_CHECKIN: "BALANCED",
  HIGH_IMPACT_SIDE_QUEST: "STRATEGIC",
  MAIN_QUEST_GENERATION: "DIRECTOR",
  CHAPTER_PLANNING: "DIRECTOR",
  TARGET_STATE_ANALYSIS: "STRATEGIC",
  CAMPAIGN_REVIEW: "STRATEGIC",
  CAMPAIGN_REPLAN: "DIRECTOR",
